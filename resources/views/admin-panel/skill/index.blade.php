        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="{{ url('admin/skills/create') }}" class="btn btn-primary btn-sm float-right mb-3">
                            ...
                            @foreach($skills as $skill)
                                ...
                                <td>
                                    <form action="{{ url('admin/skills/'. $skill->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <a href="{{ url('admin/skills/'.$skill->id.'/edit') }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit</a>
